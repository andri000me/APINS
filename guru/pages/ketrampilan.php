...
?>
    ...
    <section class="content">
		<div class="box box-primary">
			<div class="box-body">
				<form role="form" action="ketrampilan.php" method="GET">
				<div class="row">
					...
					<div class="col-lg-3 col-xs-12">
						<div class="form-group">
							...
							<input type="hidden" name="peta" class="form-control" value="4">
					...
					<div class="col-lg-3 col-xs-12">
						<div class="form-group">
							<?php if(($level==94 or $level==95 or $level==96) or ($ab>3 and $mpid==8) or ($ab>3 and $mpid==4) or ($ab>3 and $mpid==9) or ($ab>3 and $mpid==10) or ($ab>3 and $mpid==11)){?>
		...
		<div class="box box-primary">
			<div class="box-header">
              <h3 class="box-title"><?php 
								...
								?>
								Penilaian Aspek Ketrampilan <?=$mpm['nama_mapel'];?> Kelas <?=$romb;?> <?php if(($level==94 or $level==95 or $level==96) or ($ab>3 and $mpid==8) or ($ab>3 and $mpid==4) or ($ab>3 and $mpid==9) or ($ab>3 and $mpid==10) or ($ab>3 and $mpid==11)){ ?> Pembelajaran <?php }else{ ?> Tema <?php }; ?> <?=$tema;?></h3>
			  <div class="box-tools pull-right">
				...
				<div class="form-group">
					...
					<input type="hidden" name="peta" class="form-control" value="4">
					<?php 
											$tma1=mysqli_query($koneksi, "select * from pemetaan where kelas='$ab' and smt='$smt' and kd_aspek='4' and mapel='$mpid' and tema='$tema'");
			...
			<div class="box-body">
				<div class="row">
					...
					<div class="col-lg-3 col-xs-12">
						...
						<div class="box-body">
						  Praktek : penilaian yang menuntut siswa menampilkan hasil belajarnya dalam bentuk unjuk kerja<br/>
						  Proyek : tugas yang harus diselesaikan dalam periode/waktu tertentu<br/>
...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		nK3 = $("#nilaiHarian").DataTable({
				"searching": false,
				"ajax": "../modul/harian/dataKet.php?kelas=<?=$romb;?>&tapel=<?=$tapel;?>&smt=<?=$smt;?>&mp=<?=$mpid;?>&peta=<?=$peta;?>&kd=<?=$kd;?>&tema=<?=$tema;?>",
				"order": []
			});
	});
