			...
			<div class="col-lg-12 col-xs-12">
				<div class="box box-primary">
					<div class="box-header">
					  <h3 class="box-title">Kriteria Ketuntasan Minimal <?=$mpm['nama_mapel'];?> Kelas <?=$romb;?> (Gunakan Enter untuk memasukkan nilai)</h3>
					</div>
					<div class="box-body">
...
<script>
	...
	function saveKKM(editableObj,column,id,kelas,tapel,mpid,jns,kd) {
		...
		$.ajax({
			...
			cache: false,
			data:'column='+column+'&value='+editableObj.innerHTML+'&id='+id+'&kelas='+kelas+'&tapel='+tapel+'&mp='+mpid+'&jns='+jns+'&kd='+kd,
	...
	$(document).ready(function() {
		KKMTablek = $("#KKMTablek").DataTable({
			"searching": false,
			"ajax": "../modul/administrasi/kkmk.php?kelas=<?=$romb;?>&tapel=<?=$tpl_aktif;?>&mapel=<?=$mpid;?>",
			"order": []
		});
	});
	<?php };?>
